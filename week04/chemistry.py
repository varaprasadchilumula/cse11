def main ():
    ...
    formula = input("Please input the chemical formula of molecule: ")

    # Get the mass of a chemical sample in grams from the user.
    grams = float(input("Please enter the amount of grams you have: "))
    ...
    symbol = parse_formula(formula, periodic_table)

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    total_mass = compute_molar_mass(symbol, periodic_table)

    # Compute the number of moles in the sample.
    total_moles = grams/total_mass
    # Print the molar mass.
    print(round(total_mass, 5))
    # Print the number of moles.
    print(round(total_moles, 5))
